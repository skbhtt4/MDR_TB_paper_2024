...
# GSVA matrix
phy_gsva <-  readRDS("../Figures/Fig_S3/phy_GSVA_all_TBSig.rds")
...
# Upload merf results
#ml_res_holder_list <- readRDS("../Figures/Merf_TBSig/ml_res_holder_list.rds")
df_imp<-c()
i<-1
...
library(phyloseq)
#phy_mic <- readRDS("../Figures/Merf_TBSig/phy_mic.rds")
...
phy_gene_mod <- readRDS("../Figures/Fig_S3/phy_GSVA_all_TBSig.rds")
...
pdf(paste0(fig_folder,"/Fig_2B.pdf"),height = 10, width = 16,useDingbats = F)
draw(ht1)
dev.off()
